"""
Sample API calls:
    GET - http://127.0.0.1:5000/api/v1/view/card/00379eea64d5330747d109b3c12e2045
...
def view_card(db_conn, req, card_id, flag):
...
class ViewCard:
    ...
    def on_get(self, req, resp, card_id):
        try:
            ...
            result = view_card(self.db_conn, req, card_id, "true")
            if result:
                message = "Viewed card"
